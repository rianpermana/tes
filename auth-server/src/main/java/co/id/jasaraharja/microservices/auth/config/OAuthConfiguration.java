...
//					.password("password").roles("ADMIN");
			...
			auth.ldapAuthentication()
				.contextSource()
					...
					.managerDn("cn=Manager,dc=dev,dc=expecc,dc=com")
					.managerPassword("welcomeexpecc")
				.and()
					.userSearchBase("ou=people,dc=dev,dc=expecc,dc=com")
					.userSearchFilter("(uid={0})")
					.groupSearchBase("ou=groups,dc=dev,dc=expecc,dc=com")
